...
const body = document.querySelector("body"),
    ...
    kitSection = document.querySelector(".kit"),
    ...
    dotFour = document.querySelector(".dots .four"),
    dotFive = document.querySelector(".dots .five"),
...
window.onscroll = function() {
    ...
    if (pageTitle.text === "My Beard") {
        ...
        if (window.pageYOffset < headerSection.offsetHeight * 0.5)
        {
            ...
            window.pageYOffset < aboutSection.offsetTop * 0.72
        ) {
            dots.forEach(dot => dot.classList.add("gold"));
        } else if (
            window.pageYOffset > aboutSection.offsetTop * 0.75 &&
            window.pageYOffset < kitSection.offsetTop * 0.81
        ) {
            dots.forEach(dot => dot.classList.remove("gold"));
            ...
            dotThree.classList.remove("active");
            dotFive.classList.remove("active");
